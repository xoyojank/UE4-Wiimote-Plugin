	...
	: MessageHandler(InMessageHandler)
{
	...
	Buttons[0] = EControllerButtons::FaceButtonBottom;			//WIIMOTE_BUTTON_A
	Buttons[1] = EControllerButtons::FaceButtonRight;			//WIIMOTE_BUTTON_B
	Buttons[2] = EControllerButtons::FaceButtonLeft;			//WIIMOTE_BUTTON_ONE
	Buttons[3] = EControllerButtons::FaceButtonTop;				//WIIMOTE_BUTTON_TWO
	Buttons[4] = EControllerButtons::SpecialRight;				//WIIMOTE_BUTTON_PLUS
	Buttons[5] = EControllerButtons::SpecialLeft;				//WIIMOTE_BUTTON_MINUS
	Buttons[6] = EControllerButtons::DPadUp;					//WIIMOTE_BUTTON_UP
	Buttons[7] = EControllerButtons::DPadDown;					//WIIMOTE_BUTTON_DOWN
	Buttons[8] = EControllerButtons::DPadLeft;					//WIIMOTE_BUTTON_LEFT
	Buttons[9] = EControllerButtons::DPadRight;					//WIIMOTE_BUTTON_RIGHT
	Buttons[10] = EControllerButtons::LeftShoulder;				//NUNCHUK_BUTTON_C
	Buttons[11] = EControllerButtons::LeftTriggerThreshold;		//NUNCHUK_BUTTON_Z
	Buttons[12] = EControllerButtons::LeftStickUp;				//NUNCHUK_JOYSTICK
	Buttons[13] = EControllerButtons::LeftStickDown;			//NUNCHUK_JOYSTICK
	Buttons[14] = EControllerButtons::LeftStickLeft;			//NUNCHUK_JOYSTICK
	Buttons[15] = EControllerButtons::LeftStickRight;			//NUNCHUK_JOYSTICK
			...
			for (int i = 0; i < MAX_WIIMOTES; ++i)
			{
				...
				if (ControllerState.Wiimote && WIIMOTE_IS_CONNECTED(ControllerState.Wiimote))
				{
						...
						ControllerState.Wiimote->exp.type == EXP_MOTION_PLUS_NUNCHUK)
					{
						...
						{
							MessageHandler->OnControllerAnalog(EControllerButtons::LeftAnalogX, ControllerState.ControllerId, nc->js.x);
							ControllerState.LeftXAnalog = nc->js.x;
						}

						if (ControllerState.LeftYAnalog != nc->js.y)
						{
							MessageHandler->OnControllerAnalog(EControllerButtons::LeftAnalogY, ControllerState.ControllerId, nc->js.y);
